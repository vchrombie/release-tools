# GrimoireLab Release Tools [![Build Status](https://github.com/Bitergia/release-tools/workflows/tests/badge.svg)](https://github.com/Bitergia/release-tools/actions?query=workflow:tests+branch:master+event:push) [![codecov](https://codecov.io/gh/vchrombie/release-tools/branch/master/graph/badge.svg?token=T60WC78FPR)](https://codecov.io/gh/vchrombie/release-tools)
